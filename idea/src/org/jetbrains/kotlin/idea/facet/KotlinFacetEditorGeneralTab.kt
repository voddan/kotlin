...
class KotlinFacetEditorGeneralTab(
    ...
    override fun apply() {
        ...
        with(configuration.settings) {
            ...
            languageLevel = LanguageVersion.fromVersionString(compilerArguments?.languageVersion)
            apiLevel = LanguageVersion.fromVersionString(compilerArguments?.apiVersion)
        }
    }
