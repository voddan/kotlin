        ...
        get() = compilerArguments?.let {
            when (it) {
                is K2JVMCompilerArguments -> {
                    ...
                    TargetPlatformKind.Jvm.JVM_PLATFORMS.firstOrNull {
    ...
    var coroutineSupport: CoroutineSupport
        ...
        set(value) {
            compilerArguments?.let {
                it.coroutinesEnable = value == CoroutineSupport.ENABLED
                it.coroutinesWarn = value == CoroutineSupport.ENABLED_WITH_WARNING
                it.coroutinesError = value == CoroutineSupport.DISABLED
            }
        }
}
